      ...
      for (let i = 0; i < 2; ++i) {
        ...
        assert.deepStrictEqual(
          ...
          [
            ...
            '<figure data-label="$-0.0" data-group="$" style="display: none;" data-index="4.1"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            '<figure data-label="$-0.0.2.0" data-group="$" style="display: none;" data-index="4.1.2.0"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            '<figure data-label="$-0.0.1.4.0" data-group="$" style="display: none;" data-index="4.1.3.4.0"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            '<h2 id="index:0">0</h2>',
            '<h2 id="index:0">0</h2>',
            '<figure data-label="$-0.0" data-group="$" style="display: none;" data-index="6.0"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
      ...
      for (let i = 0; i < 2; ++i) {
        ...
        assert.deepStrictEqual(
          ...
          [
            ...
            '<aside class="example" data-type="markdown"><pre>~~~figure $fig-a\n&gt; \n\n~~~\n\n$fig-a</pre><div><figure data-label="fig-a" data-group="fig" data-index="1"><div class="figcontent"><blockquote></blockquote></div><span class="figindex">Fig. 1. </span><figcaption></figcaption></figure><p><a rel="noopener" class="label" data-label="fig-a">Fig. 1</a></p></div><ol></ol><ol></ol></aside>',
