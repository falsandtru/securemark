      ...
      for (let i = 0; i < 3; ++i) {
        ...
        assert.deepStrictEqual(
          ...
          [
            ...
            '<p><a class="label disabled invalid" data-label="fig-1" data-invalid-syntax="label" data-invalid-type="reference" data-invalid-message="Missing reference.">$fig-1</a></p>',
          ]);
      }
    });
