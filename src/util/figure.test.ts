      ...
      for (let i = 0; i < 2; ++i) {
        ...
        assert.deepStrictEqual(
          ...
          [
            ...
            '<figure data-label="fig-d" data-group="fig" data-number="1.1.3" id="label:fig-d"><div class="figcontent"><blockquote></blockquote></div><span class="figindex">Fig. 1.1.3. </span><figcaption></figcaption></figure>',
      ...
      for (let i = 0; i < 2; ++i) {
        ...
        assert.deepStrictEqual(
          ...
          [
            ...
            '<figure data-label="fig-a-0.0" data-group="fig" data-number="1.1" id="label:fig-a"><div class="figcontent"><blockquote></blockquote></div><span class="figindex">Fig. 1.1. </span><figcaption></figcaption></figure>',
            '<figure data-label="$-3.1" data-group="$" data-number="3.1" id="label:$-3.1"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex">(3.1)</span><figcaption></figcaption></figure>',
    ...
    it('base', () => {
      ...
      for (let i = 0; i < 2; ++i) {
        ...
        assert.deepStrictEqual(
          [...source.children].map(el => el.outerHTML),
          [
            '<figure data-label="$-0.0" data-group="$" style="display: none;" data-number="0.0"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            '<h2 id="index:0">0</h2>',
            '<figure data-label="fig-1" data-group="fig" data-number="1" id="label:fig-1"><div class="figcontent"><blockquote></blockquote></div><span class="figindex">Fig. 1. </span><figcaption></figcaption></figure>',
            '<figure data-label="fig-a-0.0" data-group="fig" data-number="1.1" id="label:fig-a"><div class="figcontent"><blockquote></blockquote></div><span class="figindex">Fig. 1.1. </span><figcaption></figcaption></figure>',
            '<h2 id="index:0">0</h2>',
            ...
            '<h2 id="index:0">0</h2>',
            '<figure data-label="$-0.0.0" data-group="$" style="display: none;" data-number="3.0.0"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            ...
            '<h2 id="index:0">0</h2>',
            '<figure data-label="$-0.1.0" data-group="$" style="display: none;" data-number="4.1.0"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            ...
            '<figure data-label="$-0.0" data-group="$" style="display: none;" data-number="4.1"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            '<figure data-label="$-0.0.2.0" data-group="$" style="display: none;" data-number="4.1.2.0"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            '<figure data-label="$-0.0.1.4.0" data-group="$" style="display: none;" data-number="4.1.3.4.0"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            '<h2 id="index:0">0</h2>',
            '<h2 id="index:0">0</h2>',
            '<figure data-label="$-0.0" data-group="$" style="display: none;" data-number="6.0"><div class="figcontent"><div class="math notranslate">$$\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>',
            ...
            '<figure data-label="fig-d" data-group="fig" data-number="5.1" id="label:fig-d"><div class="figcontent"><blockquote></blockquote></div><span class="figindex">Fig. 5.1. </span><figcaption></figcaption></figure>',
          ]);
      }
    });
