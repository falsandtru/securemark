      ...
      for (let i = 0; i < 2; ++i) {
        ...
        assert.deepStrictEqual(
          ...
          [
            ...
            '<h2 id="index:0">0</h2>',
            '<figure data-label="$-0.0.0" data-group="$" style="display: none;" data-number="3.0.0"></figure>',
            ...
            '<h2 id="index:0">0</h2>',
            '<figure data-label="$-0.1.0" data-group="$" style="display: none;" data-number="4.1.0"></figure>',
            ...
            '<figure data-label="$-0.0" data-group="$" style="display: none;" data-number="4.1"></figure>',
            '<figure data-label="$-0.1.0" data-group="$" style="display: none;" data-number="4.2.0"></figure>',
            '<figure data-label="$-0.4.0" data-group="$" style="display: none;" data-number="4.4.0"></figure>',
            '<figure data-label="$-0.1.0" data-group="$" style="display: none;" data-number="4.5.0"></figure>',
            '<h2 id="index:0">0</h2>',
            '<h2 id="index:0">0</h2>',
