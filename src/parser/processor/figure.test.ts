      ...
      for (let i = 0; i < 3; ++i) {
        ...
        assert.deepStrictEqual(
          ...
          [
            ...
            '<h2 id="index:0">0</h2>',
            `<figure data-label="$-0.0.0" data-group="$" class="invalid" data-invalid-syntax="figure" data-invalid-type="argument" data-invalid-message="Base index's format must be $-x.0"></figure>`,
            '<h3 id="index:0">0</h3>',
            ...
            '<h2 id="index:0">0</h2>',
            `<figure data-label="$-0.1.0" data-group="$" class="invalid" data-invalid-syntax="figure" data-invalid-type="argument" data-invalid-message="Base index's format must be $-x.0"></figure>`,
            ...
            '<figure data-label="$-0" data-group="$" class="invalid" data-invalid-syntax="figure" data-invalid-type="argument" data-invalid-message="Index 0 is not allowed"></figure>',
