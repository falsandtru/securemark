...
export function defrag<P extends Parser<Node, any, object, object>>(parser: P): P;
...
export function trimNode<P extends Parser<HTMLElement | Text, any, object, object>>(parser: P): P;
...
export function trimNodeEnd<P extends Parser<HTMLElement | Text, any, object, object>>(parser: P): P;
...
function trimNode_<P extends Parser<HTMLElement | Text, any, object, object>>(parser: P, mode: 'start' | 'end'): P;
