...
describe('Unit: parser/inline/annotation', () => {
  describe('annotation', () => {
    ...
    it('nest', () => {
      ...
      assert.deepStrictEqual(inspect(parser('((<a>))')), [['<sup class="annotation"><span class="invalid" data-invalid-syntax="html" data-invalid-message="Invalid tag name, attribute, or invisible content">&lt;a&gt;</span></sup>'], '']);
