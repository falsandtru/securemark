...
import { union, some, creator, recursion, precedence, surround, lazy } from '../../combinator';
import { optimize } from './link';
import { escsource, str } from '../source';
import { html } from 'typed-dom/dom';
import { unshift } from 'spica/array';

export const template: TemplateParser = lazy(() => creator(recursion(precedence(2, surround(
