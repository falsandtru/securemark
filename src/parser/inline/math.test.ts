...
describe('Unit: parser/inline/math', () => {
  describe('math', () => {
    ...
    it('basic', () => {
      ...
      assert.deepStrictEqual(inspect(parser(`$a'$`)), [[`<span class="math notranslate" data-src="$a'$">$a'$</span>`], '']);
      assert.deepStrictEqual(inspect(parser(`$a''$`)), [[`<span class="math notranslate" data-src="$a''$">$a''$</span>`], '']);
      assert.deepStrictEqual(inspect(parser('$a$[A](a)')), [['<span class="math notranslate" data-src="$a$">$a$</span>'], '[A](a)']);
      assert.deepStrictEqual(inspect(parser('$a$$')), [['<span class="math notranslate" data-src="$a$">$a$</span>'], '$']);
      assert.deepStrictEqual(inspect(parser('$A$')), [['<span class="math notranslate" data-src="$A$">$A$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$\\$$')), [['<span class="math notranslate" data-src="$\\$$">$\\$$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$\\Pi$')), [['<span class="math notranslate" data-src="$\\Pi$">$\\Pi$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$\\Pi $')), [['<span class="math notranslate" data-src="$\\Pi $">$\\Pi $</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$|1|$')), [['<span class="math notranslate" data-src="$|1|$">$|1|$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$[0,1)$]')), [['<span class="math notranslate" data-src="$[0,1)$">$[0,1)$</span>'], ']']);
      assert.deepStrictEqual(inspect(parser('$(0, 1]$)')), [['<span class="math notranslate" data-src="$(0, 1]$">$(0, 1]$</span>'], ')']);
      assert.deepStrictEqual(inspect(parser('$\\{0,1\\}$')), [['<span class="math notranslate" data-src="$\\{0,1\\}$">$\\{0,1\\}$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$n=1$')), [['<span class="math notranslate" data-src="$n=1$">$n=1$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$n<m$')), [['<span class="math notranslate" data-src="$n<m$">$n&lt;m$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$n>m$')), [['<span class="math notranslate" data-src="$n>m$">$n&gt;m$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$E = mc^2$')), [['<span class="math notranslate" data-src="$E = mc^2$">$E = mc^2$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$f(x)$')), [['<span class="math notranslate" data-src="$f(x)$">$f(x)$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$f: x \\to y$')), [['<span class="math notranslate" data-src="$f: x \\to y$">$f: x \\to y$</span>'], '']);
      assert.deepStrictEqual(inspect(parser('$k$-space')), [['<span class="math notranslate" data-src="$k$">$k$</span>'], '-space']);
    });
