...
import { union, some, subline, validate, rewrite, surround, convert, configure, lazy, fmap } from '../../../combinator';
import { link } from '../link';
import { indexee } from './indexee';
import { define } from 'typed-dom';

export const index: ExtensionParser.IndexParser = lazy(() => subline(fmap(validate(
  '[#',
