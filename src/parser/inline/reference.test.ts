...
describe('Unit: parser/inline/reference', () => {
  describe('reference', () => {
    ...
    it('nest', () => {
      ...
      assert.deepStrictEqual(inspect(parser('[[@a]]')), [['<sup class="reference"><a class="account" href="/@a" rel="noopener">@a</a></sup>'], '']);
      assert.deepStrictEqual(inspect(parser('[[http://host]]')), [['<sup class="reference"><a href="http://host" rel="noopener" target="_blank">http://host</a></sup>'], '']);
    ...
    it('alias', () => {
      ...
      assert.deepStrictEqual(inspect(parser('[[~X, 2020]]')), [['<sup class="reference" data-alias="X, 2020"></sup>'], '']);
      assert.deepStrictEqual(inspect(parser('[[~X, Y, 2020, p1-2]]')), [['<sup class="reference" data-alias="X, Y, 2020, p1-2"></sup>'], '']);
      assert.deepStrictEqual(inspect(parser('[[~X, Y, 2020, p1-2| a]]')), [['<sup class="reference" data-alias="X, Y, 2020, p1-2">a</sup>'], '']);
    });
