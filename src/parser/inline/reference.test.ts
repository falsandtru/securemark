...
describe('Unit: parser/inline/reference', () => {
  describe('reference', () => {
    ...
    it('alias', () => {
      ...
      assert.deepStrictEqual(inspect(parser('[[~X, Y. Zw, 2020, p1-2]]')), [['<sup class="reference" data-alias="X, Y. Zw, 2020, p1-2"></sup>'], '']);
      assert.deepStrictEqual(inspect(parser('[[~X| a]]')), [['<sup class="reference" data-alias="X">a</sup>'], '']);
    });
