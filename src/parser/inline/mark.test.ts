...
describe('Unit: parser/inline/mark', () => {
  describe('mark', () => {
    ...
    it('basic', () => {
      ...
      assert.deepStrictEqual(inspect(parser('==a=b==')), [['<mark id="mark::a=b=33ShX7">a=b</mark>', '<a href="#mark::a=b=33ShX7"></a>'], '']);
    ...
    it('nest', () => {
      ...
      assert.deepStrictEqual(inspect(parser('==a\\ ==b====')), [['<mark id="mark::a_b">a <mark id="mark::b">b</mark><a href="#mark::b"></a></mark>', '<a href="#mark::a_b"></a>'], '']);
      assert.deepStrictEqual(inspect(parser('==a&Tab;==b====')), [['<mark id="mark::a_b=3m1hao">a\t<mark id="mark::b">b</mark><a href="#mark::b"></a></mark>', '<a href="#mark::a_b=3m1hao"></a>'], '']);
