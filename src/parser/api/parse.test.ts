    ...
    it('separation', () => {
      assert.deepStrictEqual(
        ...
        [
          ...
          '<aside class="example" data-type="markdown"><pre translate="no">---\nURL: https://example/y\n---\n\n{#}</pre><hr><section><details class="header"><summary>Header</summary>URL: https://example/y</details><p><a href="https://example/y#" target="_blank">#</a></p><ol class="annotation"></ol><ol class="reference"></ol></section></aside>',
