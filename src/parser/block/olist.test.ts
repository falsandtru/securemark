...
describe('Unit: parser/block/olist', () => {
  describe('olist', () => {
    ...
    it('invalid', () => {
      ...
      assert.deepStrictEqual(inspect(parser('0. !http://host')), [['<ol><li class="invalid" data-invalid-syntax="listitem" data-invalid-type="content">Invalid syntax: ListItem: Unable to contain media syntax in lists.</li></ol>'], '']);
      assert.deepStrictEqual(inspect(parser('0. !http://host\n0. 0')), [['<ol><li class="invalid" data-invalid-syntax="listitem" data-invalid-type="content">Invalid syntax: ListItem: Unable to contain media syntax in lists.</li><li>0</li></ol>'], '']);
      assert.deepStrictEqual(inspect(parser('0. 1\n 0. !http://host\n0. 2')), [['<ol><li>1<ol><li class="invalid" data-invalid-syntax="listitem" data-invalid-type="content">Invalid syntax: ListItem: Unable to contain media syntax in lists.</li></ol></li><li>2</li></ol>'], '']);
      assert.deepStrictEqual(inspect(parser(' 0.')), undefined);
    });
    ...
    it('index', () => {
      ...
      assert.deepStrictEqual(inspect(parser('01. ')), [['<ol start="1" type="1"><li value="1"></li></ol>'], '']);
