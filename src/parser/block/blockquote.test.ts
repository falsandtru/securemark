...
describe('Unit: parser/block/blockquote', () => {
  describe('blockquote', () => {
    ...
    it('markdown', () => {
      ...
      assert.deepStrictEqual(inspect(parser('!>> ((a))\n> ((a))')), [['<blockquote><blockquote><p><sup class="annotation" title="a"><a rel="noopener">*1</a></sup></p><ol class="annotation"><li>a<sup><a rel="noopener"> ~1</a></sup></li></ol><ol class="reference"></ol></blockquote><p><sup class="annotation" title="a"><a rel="noopener">*1</a></sup></p><ol class="annotation"><li>a<sup><a rel="noopener"> ~1</a></sup></li></ol><ol class="reference"></ol></blockquote>'], '']);
    });
