...
describe('Unit: parser/block/blockquote', () => {
  describe('blockquote', () => {
    ...
    it('basic', () => {
      ...
      assert.deepStrictEqual(inspect(parser('> a\n>>1')), [['<blockquote><pre>a<br><span class="quotation">&gt;<a class="address" href="?res=1" rel="noopener">&gt;1</a></span></pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('> a\n> b ')), [['<blockquote><pre>a<br>b </pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('> a\n>\n')), [['<blockquote><pre>a<br></pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('> a\n>\nb')), [['<blockquote><pre>a<br><br>b</pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('> a\n>\n b ')), [['<blockquote><pre>a<br><br> b </pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('> a\n>\n>')), [['<blockquote><pre>a<br><br></pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('> a\n>\n>>1')), [['<blockquote><pre>a<br><br><span class="quotation">&gt;<a class="address" href="?res=1" rel="noopener">&gt;1</a></span></pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('> a\n>\n> b ')), [['<blockquote><pre>a<br><br>b </pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('> a\\\nb')), [['<blockquote><pre>a\\<br>b</pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('>  a ')), [['<blockquote><pre> a </pre></blockquote>'], '']);
      ...
      assert.deepStrictEqual(inspect(parser('> >>1\n> > b')), [['<blockquote><pre><span class="quotation">&gt;<a class="address" href="?res=1" rel="noopener">&gt;1</a></span><br><span class="quotation">&gt; b</span></pre></blockquote>'], '']);
      assert.deepStrictEqual(inspect(parser('> >>1\n> > b\n> c')), [['<blockquote><pre><span class="quotation">&gt;<a class="address" href="?res=1" rel="noopener">&gt;1</a></span><br><span class="quotation">&gt; b</span><br>c</pre></blockquote>'], '']);
    });
