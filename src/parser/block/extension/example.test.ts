...
describe('Unit: parser/block/extension/example', () => {
  describe('example', () => {
    ...
    it('valid', () => {
      ...
      assert.deepStrictEqual(inspect(parser('~~~example/markdown\n$fig-a\n!https://host\n~~~')), [['<aside class="example" data-type="markdown"><pre>$fig-a\n!https://host</pre><hr><div><figure data-label="fig-a" data-group="fig" data-number="1"><div class="figcontent"><a href="https://host" rel="noopener" target="_blank"><img class="media" data-src="https://host" alt=""></a></div><span class="figindex">Fig 1. </span><figcaption></figcaption></figure></div><ol class="annotation"></ol><ol class="reference"></ol></aside>'], '']);
      assert.deepStrictEqual(inspect(parser('~~~example/markdown\n[$fig-a]\n!https://host\n~~~')), [['<aside class="example" data-type="markdown"><pre>[$fig-a]\n!https://host</pre><hr><div><figure data-label="fig-a" data-group="fig" data-number="1"><div class="figcontent"><a href="https://host" rel="noopener" target="_blank"><img class="media" data-src="https://host" alt=""></a></div><span class="figindex">Fig 1. </span><figcaption></figcaption></figure></div><ol class="annotation"></ol><ol class="reference"></ol></aside>'], '']);
      assert.deepStrictEqual(inspect(parser('~~~example/markdown\n## a\n~~~')), [['<aside class="example" data-type="markdown"><pre>## a</pre><hr><div><h2>a</h2></div><ol class="annotation"></ol><ol class="reference"></ol></aside>'], '']);
      assert.deepStrictEqual(inspect(parser('~~~example/markdown\n~ a\n~~~')), [['<aside class="example" data-type="markdown"><pre>~ a</pre><hr><div><dl><dt>a</dt><dd></dd></dl></div><ol class="annotation"></ol><ol class="reference"></ol></aside>'], '']);
      assert.deepStrictEqual(inspect(parser('~~~example/markdown\n((a))[[b]]\n~~~')), [['<aside class="example" data-type="markdown"><pre>((a))[[b]]</pre><hr><div><p><sup class="annotation disabled" title="a"><a rel="noopener">*1</a></sup><sup class="reference disabled" title="b"><a rel="noopener">[1]</a></sup></p></div><ol class="annotation"><li>a<sup><a rel="noopener">~1</a></sup></li></ol><ol class="reference"><li>b<sup><a rel="noopener">~1</a></sup></li></ol></aside>'], '']);
      assert.deepStrictEqual(inspect(parser('~~~~example/markdown\na\n~~~~')), [['<aside class="example" data-type="markdown"><pre>a</pre><hr><div><p>a</p></div><ol class="annotation"></ol><ol class="reference"></ol></aside>'], '']);
      assert.deepStrictEqual(inspect(parser('~~~example/math\na\n~~~')), [['<aside class="example" data-type="math"><pre>a</pre><hr><div class="math notranslate">$$\na\n$$</div></aside>'], '']);
