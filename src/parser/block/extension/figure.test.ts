...
describe('Unit: parser/block/extension/figure', () => {
  describe('figure', () => {
    ...
    it('valid', () => {
      ...
      assert.deepStrictEqual(inspect(parser('~~~figure [$group-name-0.0]\n> \n\n~~~')), [['<figure data-label="group-name-0.0" data-group="group"><div class="figcontent"><blockquote></blockquote></div><span class="figindex"></span><figcaption></figcaption></figure>'], '']);
      ...
      assert.deepStrictEqual(inspect(parser('~~~figure [$-name-0.0]\n$$\n\n$$\n~~~')), [['<figure data-label="$-name-0.0" data-group="$"><div class="figcontent"><div class="math notranslate">$$\n\n$$</div></div><span class="figindex"></span><figcaption></figcaption></figure>'], '']);
