...
describe('Unit: parser/block/extension/figure', () => {
  describe('figure', () => {
    ...
    it('valid', () => {
      ...
      assert.deepStrictEqual(inspect(parser('~~~figure [:type-name]\n|\n|-\n|\n~~~')), [['<figure class="label:type-name"><table><thead><tr><td align=""></td></tr></thead><tbody><tr><td align=""></td></tr></tbody></table><figcaption data-type="type"><span></span></figcaption></figure>'], '']);
