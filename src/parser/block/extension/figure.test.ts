...
describe('Unit: parser/block/extension/figure', () => {
  describe('figure', () => {
    ...
    it('valid', () => {
      ...
      assert.deepStrictEqual(inspect(parser('~~~figure [$group-name]\n~~~example/markdown\n~~~\n~~~')), [['<figure data-label="group-name" data-group="group"><div class="figcontent"><aside class="example" data-type="markdown"><pre></pre><div></div><ol class="annotation"></ol><ol class="reference"></ol></aside></div><span class="figindex"></span><figcaption></figcaption></figure>'], '']);
