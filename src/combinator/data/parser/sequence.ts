import { Parser, CtxOptions, Node, Context, SubParsers, SubNode, eval, exec, check } from '../parser';
...
export function sequence<N, D extends Parser<N>[]>(parsers: D, resume?: (nodes: N[], rest: string) => boolean): Parser<N, CtxOptions, D> {
