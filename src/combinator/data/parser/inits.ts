...
export function inits<P extends Parser>(parsers: Parser.SubParsers<P>, resume?: (nodes: List<Data<Parser.SubNode<P>>>) => boolean): Parser.SubNode<P> extends Parser.Node<P> ? P : Parser<Parser.SubNode<P>, Parser.Context<P>, Parser.SubParsers<P>>;
