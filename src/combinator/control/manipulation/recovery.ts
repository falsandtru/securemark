...
export function recover<T, D extends Parser<unknown>[]>(parser: Parser<T, D>, fallback: (source: string, context: Ctx, reason: unknown) => Result<Data<Parser<T, D>>, SubParsers<Parser<T, D>>>): Parser<T, D> {
