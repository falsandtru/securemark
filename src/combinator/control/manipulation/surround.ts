...
export function surround<T, D extends Parser<unknown, any, object>[]>(start: string | RegExp, parser: Parser<T, D, object>, end: string | RegExp, strict = true): Parser<T, D, object> {
