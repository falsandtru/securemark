import { Parser, Ctx, Tree, SubParsers, Context } from '../../data/parser';
import { fmap } from '../monad/fmap';

export function dup<P extends Parser<unknown[]>>(parser: Parser<Tree<P>[number], SubParsers<P>, Context<P>>): P;
