...
export function bind<P extends Parser<unknown, any>>(parser: SubParser<P>, f: (rs: SubData<P>[], rest: string, config: Config<P>, state: State<P>) => Result<Data<P>, SubParsers<P>, Config<P>, State<P>>): P;
