/*! securemark v0.42.0 https://github.com/falsandtru/securemark | (c) 2018, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function () {
    function e(t, n, r) {
        function s(o, u) {
            if (!n[o]) {
    ...
    17: [
        ...
        {
            './combinator/bracket': 18,
            './combinator/combine': 19,
            './combinator/loop': 20,
            './combinator/subsequence': 21,
            './combinator/transform': 22
        }
    ],
    18: [
        function (require, module, exports) {
    ...
    26: [
        ...
        },
        {
            '../../combinator': 17,
            '../block': 25,
            '../source/unescapable': 75,
            '../squash': 77,
            './util/verification': 43,
            'typed-dom': 11
        }
    ],
    27: [
    ...
    46: [
        ...
        {
            '../combinator': 17,
            './inline/anglebracket': 47,
            './inline/annotation': 48,
            './inline/autolink': 49,
            './inline/brace': 52,
            './inline/bracket': 53,
            './inline/code': 54,
            ...
            './inline/extension': 56,
            './inline/html': 60,
            './inline/htmlentity': 61,
            './inline/link': 62,
            './inline/math': 63,
            './inline/media': 64,
            './inline/parenthesis': 65,
            './inline/strong': 66,
            './source/text': 74
        }
    ],
    ...
    94: [
        function (require, module, exports) {
            ...
            function toc(source) {
                ...
                function parse(node) {
                    return typed_dom_1.html('ul', node.map(node => node instanceof Element ? typed_dom_1.html('li', [typed_dom_1.html('a', { href: `#${ node.id }` }, node.textContent)]) : typed_dom_1.html('li', [
                        typed_dom_1.html('a', { href: `#${ node[0].id }` }, node[0].textContent),
                        parse(node[1])
                    ])));
                }
                function cons(hs) {
