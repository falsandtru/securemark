/*! securemark v0.190.8 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | UNLICENSED */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
    ...
    61: [
        function (_dereq_, module, exports) {
            ...
            function sync(editor, viewer, footnotes) {
                ...
                return typed_dom_1.bind(editor, 'scroll', () => {
                    ...
                    default:
                        viewer.scrollBy({
                            top: +footnotes.reduce((acc, el) => {
                                const {marginTop, marginBottom} = global_1.window.getComputedStyle(el);
                                return acc - el.clientHeight - +marginTop.slice(0, -2) - +marginBottom.slice(0, -2);
                            }, viewer.scrollHeight) * (curr - prev) / editor.scrollHeight
                        });
                    }
                    prev = curr;
                }, { passive: true });
    ...
    79: [
        ...
        },
        {
            ...
            '../source': 124,
            '../util': 131,
            './paragraph/mention': 80,
            './paragraph/mention/quotation': 82,
            'spica/array': 6,
            'typed-dom': 21
        }
    ],
    ...
    86: [
        ...
        {
            '../combinator': 28,
            './inline/annotation': 87,
            './inline/autolink': 88,
            './inline/autolink/address': 90,
            './inline/bracket': 96,
            './inline/code': 97,
            './inline/comment': 98,
            './inline/deletion': 99,
            ...
            './inline/emstrong': 101,
            './inline/escape': 102,
            './inline/extension': 103,
            './inline/extension/indexee': 105,
            './inline/extension/indexer': 106,
            './inline/html': 109,
            './inline/htmlentity': 110,
            './inline/insertion': 111,
            './inline/link': 112,
            './inline/mark': 113,
            './inline/math': 114,
            './inline/media': 115,
            './inline/reference': 116,
            './inline/ruby': 117,
            './inline/shortmedia': 118,
            './inline/strong': 119,
            './inline/template': 120,
            './source': 124
        }
    ...
    124: [
        ...
        {
            './source/escapable': 125,
            './source/line': 126,
            './source/linebreak': 127,
            './source/str': 128,
            './source/text': 129,
    ...
    145: [
        ...
        {
            '../parser/inline/extension/label': 107,
            'spica/array': 6,
            'spica/global': 12,
            'spica/multimap': 14,
            'typed-dom': 21
    ...
    146: [
        ...
        {
            '../parser/inline/extension/indexee': 105,
            'spica/global': 12,
            'spica/memoize': 13,
            'spica/multimap': 14,
            'typed-dom': 21
