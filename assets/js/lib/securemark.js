/*! securemark v0.123.1 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
    ...
    71: [
        function (_dereq_, module, exports) {
            ...
            exports.autolink = combinator_1.fmap(combinator_1.some(combinator_1.union([
                ...
                hashtag_1.hashtag,
                hashref_1.hashref,
                combinator_1.focus(/^(?:[a-zA-Z0-9]|[^\x00-\x7F\s])(?=#)/, combinator_1.some(unescapable_1.unescsource))
