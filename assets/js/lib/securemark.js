/*! securemark v0.39.1 https://github.com/falsandtru/securemark | (c) 2018, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function e(t, n, r) {
    ...
    40: [
        ...
        {
            '../combinator': 14,
            './inline/anglebracket': 41,
            './inline/annotation': 42,
            './inline/autolink': 43,
            './inline/brace': 47,
            './inline/bracket': 48,
            './inline/code': 49,
            ...
            './inline/extension': 51,
            './inline/html': 55,
            './inline/htmlentity': 56,
            './inline/link': 57,
            './inline/mathinline': 58,
            './inline/media': 59,
            './inline/parenthesis': 60,
            './inline/strong': 61,
            './source/text': 69
        }
    ],
        ...
        function (require, module, exports) {
            ...
            exports.hashtag = source => {
                ...
                if (!source.startsWith('#'))
                    return;
                const line = source.split('\n', 1)[0];
                const [ts = [], rest = undefined] = combinator_1.loop(combinator_1.combine([text_1.text]), url_1.closer)(line) || [];
                if (rest === undefined)
                    return;
                const el = document.createElement('a');
