...
require = function e(t, n, r) {
    ...
    14: [
        ...
        {
            '../combinator/combine': 11,
            './block/blockquote': 15,
            './block/dlist': 16,
            './block/extension': 17,
            './block/heading': 19,
            './block/horizontalrule': 20,
            './block/mathblock': 22,
            './block/newline': 23,
            './block/olist': 24,
            './block/paragraph': 25,
    ...
    29: [
        ...
        {
            '../combinator/combine': 11,
            './inline/annotation': 30,
            './inline/autolink': 31,
            './inline/code': 34,
            './inline/deletion': 35,
            './inline/emphasis': 36,
            './inline/html': 37,
            './inline/htmlentity': 38,
            './inline/insertion': 39,
            './inline/link': 40,
            './inline/mathinline': 41,
            './inline/media': 42,
            './inline/parenthesis': 43,
            './inline/strong': 44,
            './inline/subscript': 45,
            './inline/superscript': 46,
            './text/text': 51
        }
    ],
    30: [
    ...
    47: [
        ...
        {
            '../combinator/combine': 11,
            '../parser/block/extension': 17,
            '../parser/block/mathblock': 22,
            '../parser/block/pretext': 26
        }
    ],
    48: [
        function (require, module, exports) {
            ...
            function math(source) {
                ...
                if (cache.has(expr)) {
                    ...
                    void MathJax.Hub.Queue([
                        ...
                        source,
                        function () {
                            return void cache.set(expr, source);
                        }
                    ]);
                }
            }
