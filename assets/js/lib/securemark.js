/*! securemark v0.195.1 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | UNLICENSED */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
    ...
    80: [
        ...
        },
        {
            ...
            '../source': 125,
            '../util': 132,
            './paragraph/mention': 81,
            './paragraph/mention/quotation': 83,
            'spica/array': 6,
            'typed-dom': 23
        }
    ],
    ...
    84: [
        function (_dereq_, module, exports) {
            ...
            exports.table = combinator_1.lazy(() => combinator_1.block(combinator_1.fmap(combinator_1.validate(/^\|[^\n]*(?:\n\|[^\n]*){2,}/, combinator_1.sequence([
                row(combinator_1.some(data), true),
                row(combinator_1.some(align), false),
                combinator_1.some(row(combinator_1.some(data), true))
            ])), rows => {
                const [head, align] = array_1.shift(rows, 2)[0];
                const aligns = array_1.push([], align.children).map(el => el.textContent);
            ...
            const data = combinator_1.creator(combinator_1.fmap(combinator_1.surround(/^\|(?:\\?\s)*(?=\S)/, combinator_1.some(combinator_1.union([inline_1.inline]), /^(?:\\?\s)*(?=\||\\?$)/), /^[^|]*/, true), ns => [typed_dom_1.html('td', util_1.defrag(ns))]));
    ...
    125: [
        ...
        },
        {
            ...
            './source/line': 127,
            './source/linebreak': 128,
            './source/str': 129,
            './source/text': 130,
            './source/unescapable': 131
        }
    ],
    126: [
        function (_dereq_, module, exports) {
    ...
    146: [
        ...
        {
            '../parser/inline/extension/label': 108,
            'spica/array': 6,
            'spica/global': 14,
            'spica/multimap': 16,
            'typed-dom': 23
    ...
    147: [
        ...
        {
            '../parser/inline/extension/indexee': 106,
            'spica/global': 14,
            'spica/memoize': 15,
            'spica/multimap': 16,
            'typed-dom': 23
        ...
        function (_dereq_, module, exports) {
            ...
            function sync(editor, viewer, bottom = viewer.firstElementChild) {
                ...
                return function_1.clear(arrow_1.aggregate(typed_dom_1.once(viewer, 'mousemove', () => {
                    ...
                    hover = false;
                }, passive), typed_dom_1.bind(editor, 'focus', () => {
                    hover = true;
