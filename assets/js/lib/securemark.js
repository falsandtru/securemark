/*! securemark v0.105.0 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
    ...
    17: [
        function (require, module, exports) {
            ...
            exports.frag = frag;
            function shadow(el, children, opts = { mode: 'open' }) {
                if (children && !isChildren(children))
                    return shadow(el, undefined, children);
                if (typeof children === 'string')
                    return shadow(el, [text(children)]);
                if (children === undefined && !el.shadowRoot)
                    return shadow(el, el.childNodes, opts);
    ...
    71: [
        function (require, module, exports) {
            ...
            const emoji_1 = require('./inline/emoji');
