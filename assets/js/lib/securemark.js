/*! securemark v0.94.6 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
            ...
            exports.figure = combinator_1.block(combinator_1.rewrite(exports.segment, combinator_1.verify(combinator_1.match(/^(~{3,})figure[^\S\n]+(\[:\S+?\])[^\S\n]*\n((?:[^\n]*\n)*?)\1\s*$/, ([, , param, body], rest) => combinator_1.bind(combinator_1.sequence([
                ...
                combinator_1.inits([
                    combinator_1.block(combinator_1.union([
                        ...
                        example_1.example,
                        blockquote_1.blockquote,
                        combinator_1.line(combinator_1.rewrite(inline_2.media, combinator_1.convert(source => `[${ source }]{ ${ combinator_1.eval(inline_2.media(source))[0].getAttribute('data-src') || '#' } }`, inline_2.link))),
                        combinator_1.line(combinator_1.contract('!', inline_2.uri, ([node]) => node instanceof Element))
                    ])),
                    line_1.emptyline,
                    combinator_1.block(combinator_1.union([
                        line_1.blankline,
    ...
    70: [
        function (require, module, exports) {
            ...
            const util_1 = require('../util');
            const typed_dom_1 = require('typed-dom');
            exports.annotation = combinator_1.verify(combinator_1.fmap(combinator_1.lazy(() => combinator_1.surround('((', util_1.defrag(combinator_1.some(combinator_1.union([inline_1.inline]), '))')), '))')), ns => [typed_dom_1.html('sup', { class: 'annotation' }, ns)]), ([el]) => util_1.startsWithTightText(el) && !util_1.hasAnnotationOrAuthority(el) && !util_1.hasMedia(el));
        },
        {
            '../../combinator': 20,
            '../inline': 69,
    ...
    71: [
        function (require, module, exports) {
            ...
            const util_1 = require('../util');
            const typed_dom_1 = require('typed-dom');
            exports.authority = combinator_1.subline(combinator_1.verify(combinator_1.fmap(combinator_1.lazy(() => combinator_1.surround('[[', util_1.defrag(combinator_1.some(combinator_1.union([inline_1.inline]), /^\n|^]]/)), ']]')), ns => [typed_dom_1.html('sup', { class: 'authority' }, ns)]), ([el]) => util_1.startsWithTightText(el) && !util_1.hasAnnotationOrAuthority(el) && !util_1.hasMedia(el)));
        },
        {
            '../../combinator': 20,
            '../inline': 69,
    ...
    81: [
        function (require, module, exports) {
            ...
            const util_1 = require('../util');
            const typed_dom_1 = require('typed-dom');
            exports.emphasis = combinator_1.contract(/^\*\S[\s\S]*?\*/, combinator_1.fmap(combinator_1.lazy(() => combinator_1.surround('*', util_1.defrag(combinator_1.some(combinator_1.union([
                strong_1.strong,
    ...
    84: [
        function (require, module, exports) {
            ...
            function identifier(index) {
                return index ? `index:${ index.trim().replace(/\s+/g, '-') }` : undefined;
            }
        },
        {
            '../../../combinator': 20,
    ...
    89: [
        function (require, module, exports) {
            ...
            exports.link = combinator_1.subline(combinator_1.bind(combinator_1.lazy(() => combinator_1.contract(/^\[.*?\]{( ?).*?\1}/, combinator_1.sequence([
    ...
    92: [
        function (require, module, exports) {
            ...
            const concat_1 = require('spica/concat');
            const typed_dom_1 = require('typed-dom');
            exports.ruby = combinator_1.subline(combinator_1.bind(combinator_1.contract(/^\[.+?\]\(.+?\)/, combinator_1.fmap(combinator_1.sequence([
    ...
    93: [
        function (require, module, exports) {
            ...
            const util_1 = require('../util');
            const typed_dom_1 = require('typed-dom');
            exports.strong = combinator_1.contract(/^\*\*\S[\s\S]*?\*\*/, combinator_1.fmap(combinator_1.lazy(() => combinator_1.surround('**', util_1.defrag(combinator_1.some(combinator_1.union([inline_1.inline]), '**')), '**')), ns => [typed_dom_1.html('strong', ns)]), ([el]) => util_1.startsWithTightText(el));
        },
        {
            '../../combinator': 20,
            '../inline': 69,
            ...
            function build(category, marker) {
                ...
                return (source, target) => {
                    ...
                    return void typed_dom_1.define(target, [...source.querySelectorAll(`.${ category }`)].reduce((acc, ref, i) => {
                        ...
                        const title = ref.title || indexer_1.index(ref);
