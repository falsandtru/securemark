...
require = function e(t, n, r) {
    ...
    13: [
        ...
        {
            './combinator/bracket': 14,
            './combinator/combine': 15,
            './combinator/loop': 16,
            './combinator/subsequence': 17,
    ...
    22: [
        ...
        },
        {
            '../../combinator': 13,
            '../block': 21,
            '../source/unescapable': 71,
            '../squash': 73,
            './util/verification': 39,
            'typed-dom': 8
        }
    ],
    23: [
    ...
    42: [
        ...
        {
            '../combinator': 13,
            './inline/anglebracket': 43,
            './inline/annotation': 44,
            './inline/autolink': 45,
            './inline/brace': 48,
            './inline/bracket': 49,
            './inline/code': 50,
            ...
            './inline/extension': 52,
            './inline/html': 56,
            './inline/htmlentity': 57,
            './inline/link': 58,
            './inline/mathinline': 59,
            './inline/media': 60,
            './inline/parenthesis': 61,
            './inline/strong': 62,
            './source/text': 70
        }
    ],
