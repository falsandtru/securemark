/*! securemark v0.9.0 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function e(t, n, r) {
    ...
    26: [
        function (require, module, exports) {
            ...
            var text_1 = require('./text');
            var syntax = /^(<([a-z]+)>)/i;
            var inlinetags = Object.freeze('small|q|cite|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|mark|ruby|rt|rp|bdi|bdo|ins|del|wbr'.split('|'));
            var cache = new Map();
