...
require = function () {
    ...
    57: [
        ...
        {
            '../combinator': 19,
            './inline/annotation': 58,
            './inline/autolink': 59,
            './inline/autolink/url': 61,
            './inline/bracket': 62,
            './inline/code': 63,
            './inline/comment': 64,
            './inline/emphasis': 65,
            './inline/extension': 66,
            './inline/extension/index': 67,
            './inline/extension/label': 68,
            './inline/html': 70,
            './inline/htmlentity': 71,
            './inline/link': 72,
            './inline/math': 73,
            './inline/media': 74,
            './inline/strong': 75,
