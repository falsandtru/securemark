/*! securemark v0.27.0 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function e(t, n, r) {
    ...
    15: [
        function (require, module, exports) {
            ...
            function verifyBlockEnd(rs, rest) {
                return rest.split('\n', 1).shift().trim() === '' ? [
                    rs,
                    rest
                ] : void 0;
        ...
        function (require, module, exports) {
            ...
            exports.blockquote = function (source) {
                ...
                while (true) {
                    ...
                    var _a = loop_1.loop(combine_1.combine([plaintext_1.plaintext]), '\n')(source) || [
                            [document.createTextNode('')],
                            source
                        ], cs = _a[0], rest = _a[1];
                    var node = mode === 'plain' ? document.createTextNode(text_1.squash(cs).textContent.replace(/ /g, String.fromCharCode(160))) : text_1.squash(cs);
                ...
                return block_1.verifyBlockEnd([top], source);
            };
            function expand(el) {
            ...
            exports.dlist = function (source) {
                ...
                while (true) {
                    ...
                    case '~': {
                            ...
                            void dt.appendChild(text_1.squash((loop_1.loop(combine_1.combine([
                                indexer_1.indexer,
                                inline_1.inline
                            ]))(line.slice(1).trim()) || [[]])[0]));
                ...
                return block_1.verifyBlockEnd([el], source);
            };
        },
        {
            '../../combinator/combine': 12,
    ...
    20: [
        function (require, module, exports) {
            ...
            exports.heading = function (source) {
                ...
                return block_1.verifyBlockEnd([el], source.slice(whole.length + 1));
            };
        },
        {
            '../../combinator/combine': 12,
    ...
    21: [
        function (require, module, exports) {
            ...
            exports.horizontalrule = function (source) {
                ...
                if (!whole)
                    return;
                return block_1.verifyBlockEnd([document.createElement('hr')], source.slice(whole.length + 1));
            };
        },
        { '../block': 15 }
    ],
        ...
        function (require, module, exports) {
            ...
            exports.indexer = function (source) {
                if (!source.trim().startsWith('[#') || source.search(syntax) !== 0)
                    return;
                source = source.trim();
                var _a = loop_1.loop(combine_1.combine([text_2.text]), /^\]/)(source.slice(2)) || [
                        [],
                        ''
                    ], cs = _a[0], rest = _a[1];
                if (rest !== ']')
    ...
    27: [
        function (require, module, exports) {
            ...
            exports.paragraph = function (source) {
                ...
                void el.appendChild(text_1.squash(cs));
                return block_1.verifyBlockEnd([el], rest.slice(rest.split('\n').shift().length + 1));
            };
        },
        {
            '../../combinator/combine': 12,
    ...
    29: [
        function (require, module, exports) {
            ...
            exports.table = function (source) {
                ...
                return block_1.verifyBlockEnd([table], source);
            };
    ...
    31: [
        function (require, module, exports) {
            ...
            var index_1 = require('./inline/index');
        ...
        {
            '../combinator/combine': 12,
            './inline/annotation': 32,
            './inline/autolink': 33,
            './inline/code': 36,
            './inline/deletion': 37,
            './inline/emphasis': 38,
            './inline/html': 39,
            './inline/htmlentity': 40,
            './inline/index': 41,
            './inline/insertion': 42,
            './inline/link': 43,
            './inline/math': 44,
            './inline/media': 45,
            './inline/parenthesis': 46,
            './inline/strong': 47,
            './inline/subscript': 48,
            './inline/superscript': 49,
            './text/text': 55
        }
    ],
    32: [
    ...
    41: [
        function (require, module, exports) {
            ...
            exports.index = function (source) {
                if (!source.startsWith('[#') || source.search(syntax) !== 0)
                    return;
                var _a = loop_1.loop(combine_1.combine([text_2.text]), /^[\]\n]/)('' + source.slice(2)) || [
                        [],
                        ''
                    ], cs = _a[0], rest = _a[1];
                if (!rest.startsWith(']'))
                    return;
                var txt = text_1.squash(cs).textContent;
                if (txt !== txt.trim())
                    return;
                var result = link_1.link('[](#' + index_1.makeIndex(txt) + ')' + rest.slice(1));
                if (!result)
                    return;
                var el = result[0][0];
                el.textContent = txt;
    ...
    55: [
        function (require, module, exports) {
            'use strict';
            Object.defineProperty(exports, '__esModule', { value: true });
            var separator = /[^0-9a-zA-Z\u0080-\uFFFF]|[\u0300-\u036F]|(?:[0-9a-zA-Z][!?]*h|\?h|[0-9a-gi-zA-Z!?])ttps?:|[0-9a-zA-Z@]?@[0-9a-zA-Z]|[、。]/u;
            var linebreaks = /^(?:(?:\\?\s)*?\\?\n)+/;
