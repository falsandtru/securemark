/*! securemark v0.190.0 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | UNLICENSED */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
    ...
    66: [
        ...
        },
        {
            '../../combinator': 28,
            './extension/aside': 67,
            './extension/example': 68,
            './extension/fig': 69,
            './extension/figbase': 70,
            './extension/figure': 71,
    ...
    78: [
        ...
        },
        {
            ...
            '../source': 123,
            '../util': 130,
            './paragraph/mention': 79,
            './paragraph/mention/quotation': 81,
            'spica/array': 6,
            'typed-dom': 21
        }
    ],
    ...
    94: [
        function (_dereq_, module, exports) {
            ...
            const source_1 = _dereq_('../../source');
            const closer = /^[-+*=~^,.;:!?]*(?=["`|\[\](){}<>]|\\?$)/;
            exports.url = combinator_1.lazy(() => combinator_1.validate('http', combinator_1.rewrite(combinator_1.open(/^https?:\/\/(?=[\x21-\x7E])/, combinator_1.focus(/^[\x21-\x7E]+/, combinator_1.some(combinator_1.union([
                bracket,
    ...
    145: [
        ...
        {
            '../parser/inline/extension/label': 106,
            'spica/array': 6,
            'spica/global': 12,
            'spica/multimap': 14,
            'typed-dom': 21
    ...
    146: [
        ...
        {
            '../parser/inline/extension/indexee': 104,
            'spica/global': 12,
            'spica/memoize': 13,
            'spica/multimap': 14,
            'typed-dom': 21
