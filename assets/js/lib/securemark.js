/*! securemark v0.88.0 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
    ...
    69: [
        ...
        {
            '../combinator': 20,
            './inblock/annotation': 70,
            './inblock/authority': 71,
            './inblock/autolink': 72,
            './inline': 75,
            './source/char': 97
        }
    ...
    71: [
        function (require, module, exports) {
            ...
            const util_1 = require('../util');
            const typed_dom_1 = require('typed-dom');
            exports.authority = combinator_1.subline(combinator_1.verify(combinator_1.fmap(combinator_1.build(() => combinator_1.surround('[[', util_1.compress(combinator_1.some(combinator_1.union([
                autolink_1.autolink,
                inline_1.inline
    ...
    75: [
        ...
        },
        {
            '../combinator': 20,
            './inline/autolink': 76,
            './inline/autolink/account': 77,
            './inline/autolink/email': 78,
    ...
    93: [
        function (require, module, exports) {
            ...
            const concat_1 = require('spica/concat');
            const typed_dom_1 = require('typed-dom');
            exports.ruby = combinator_1.subline(combinator_1.bind(combinator_1.fmap(combinator_1.build(() => combinator_1.sequence([
