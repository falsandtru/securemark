/*! securemark v0.143.0 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | UNLICENSED */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
                ...
                class Elem {
                    constructor(element, children_, container = element) {
                        ...
                        case ElChildrenType.Record:
                            ...
                            void dom_1.define(this.container, []);
                            this.children_ = observe(this.container, { ...children_ });
                            this.children = children_;
                            return;
                        default:
    ...
    30: [
        function (require, module, exports) {
            ...
            __export(require('./combinator/control/manipulation/config'));
        ...
        },
        {
            ...
            './combinator/control/manipulation/config': 35,
    ...
    79: [
        ...
        },
        {
            ...
            './inline/math': 105,
            './inline/media': 106,
            './inline/reference': 107,
            './inline/ruby': 108,
            './inline/shortmedia': 109,
            './inline/strong': 110,
            './inline/template': 111,
            './source': 115
        }
    ...
    115: [
        ...
        {
            './source/char': 116,
            './source/escapable': 117,
            './source/line': 118,
            './source/linebreak': 119,
            './source/text': 120,
            './source/unescapable': 121
        }
    ],
    116: [
        function (require, module, exports) {
