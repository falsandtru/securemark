/*! securemark v0.200.0 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | UNLICENSED */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
    ...
    68: [
        ...
        },
        {
            '../../combinator': 30,
            './extension/aside': 69,
            './extension/example': 70,
            './extension/fig': 71,
            './extension/figbase': 72,
            './extension/figure': 73,
            './extension/message': 74,
            './extension/placeholder': 75,
            './extension/table': 76
        }
    ],
    69: [
    ...
    74: [
        function (_dereq_, module, exports) {
            ...
            exports.message = combinator_1.block(combinator_1.validate('~~~', combinator_1.fmap(combinator_1.fence(/^(~{3,})message\/(\S+)([^\n]*)(?:$|\n)/, 300), ([body, closer, opener, delim, type, param], _, context) => {
                ...
                return [typed_dom_1.html('div', { class: `message type-${ type }` }, array_1.unshift([typed_dom_1.html('h6', title(type))], [...segment_1.segment(body)].flatMap(seg => combinator_1.eval(content(seg, context), []))))];
            })));
            function title(type) {
                switch (type) {
                case 'warning':
            ...
            const content = combinator_1.some(combinator_1.union([
                source_1.emptyline,
                ulist_1.ulist,
                olist_1.olist,
                ilist_1.ilist,
    ...
    82: [
        ...
        },
        {
            ...
            '../source': 127,
            '../util': 134,
            './paragraph/mention': 83,
            './paragraph/mention/quote': 85,
            'spica/array': 6,
            'typed-dom': 23
        }
    ],
    ...
    84: [
        function (_dereq_, module, exports) {
            ...
            const source_1 = _dereq_('../../../source');
            const typed_dom_1 = _dereq_('typed-dom');
            exports.anchor = combinator_1.creator(combinator_1.line(combinator_1.fmap(combinator_1.tails([
                source_1.str(/^>*(?=>)/),
                inline_1.anchor
    ...
    85: [
        function (_dereq_, module, exports) {
            ...
            exports.quote = combinator_1.lazy(() => combinator_1.creator(combinator_1.block(combinator_1.fmap(combinator_1.union([
    ...
    86: [
        function (_dereq_, module, exports) {
            ...
            ])), ns => [typed_dom_1.html('td', util_1.defrag(ns))]));
            const cell = combinator_1.surround(/^\|(?:\\?\s)*(?=\S)/, combinator_1.some(combinator_1.union([inline_1.inline]), /^(?:\\?\s)*(?=\||\\?$)/), /^[^|]*/, true);
            const head = combinator_1.creator(combinator_1.fmap(cell, ns => [typed_dom_1.html('th', util_1.defrag(ns))]));
            const data = combinator_1.creator(combinator_1.fmap(cell, ns => [typed_dom_1.html('td', util_1.defrag(ns))]));
    ...
    89: [
        function (_dereq_, module, exports) {
            'use strict';
            Object.defineProperty(exports, '__esModule', { value: true });
            exports.indexee = exports.indexer = exports.anchor = exports.autolink = exports.shortmedia = exports.math = exports.media = exports.inline = void 0;
            const combinator_1 = _dereq_('../combinator');
            ...
            var anchor_1 = _dereq_('./inline/autolink/anchor');
            Object.defineProperty(exports, 'anchor', {
                enumerable: true,
                get: function () {
                    return anchor_1.anchor;
                }
            });
        ...
        {
            '../combinator': 30,
            './inline/annotation': 90,
            './inline/autolink': 91,
            './inline/autolink/anchor': 93,
            './inline/bracket': 99,
            './inline/code': 100,
            './inline/comment': 101,
            './inline/deletion': 102,
            ...
            './inline/emstrong': 104,
            './inline/escape': 105,
            './inline/extension': 106,
            './inline/extension/indexee': 108,
            './inline/extension/indexer': 109,
            './inline/html': 112,
            './inline/htmlentity': 113,
            './inline/insertion': 114,
            './inline/link': 115,
            './inline/mark': 116,
            './inline/math': 117,
            './inline/media': 118,
            './inline/reference': 119,
            './inline/ruby': 120,
            './inline/shortmedia': 121,
            './inline/strong': 122,
            './inline/template': 123,
            './source': 127
        }
    ...
    107: [
        function (_dereq_, module, exports) {
            ...
            exports.index = combinator_1.lazy(() => combinator_1.creator(combinator_1.validate('[#', ']', '\n', combinator_1.fmap(indexee_1.indexee(combinator_1.surround('[#', combinator_1.guard(context => {
                ...
                [typed_dom_1.html('a', util_1.defrag(bs))],
                rest
    ...
    134: [
        function (_dereq_, module, exports) {
            'use strict';
            Object.defineProperty(exports, '__esModule', { value: true });
            exports.stringify = exports.defrag = exports.dup = exports.trimEndBR = exports.startTight = exports.isEndTight = void 0;
            const global_1 = _dereq_('spica/global');
            const alias_1 = _dereq_('spica/alias');
            const combinator_1 = _dereq_('../combinator');
            const comment_1 = _dereq_('./inline/comment');
    ...
    148: [
        ...
        {
            '../parser/inline/extension/label': 110,
            'spica/array': 6,
            'spica/global': 14,
            'spica/multimap': 16,
            'typed-dom': 23
    ...
    149: [
        ...
        {
            '../parser/inline/extension/indexee': 108,
            'spica/global': 14,
            'spica/memoize': 15,
            'spica/multimap': 16,
            'typed-dom': 23
