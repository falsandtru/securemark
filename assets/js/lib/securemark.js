/*! securemark v0.165.0 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | UNLICENSED */
require = function () {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
    ...
    61: [
        function (_dereq_, module, exports) {
            'use strict';
            Object.defineProperty(exports, '__esModule', { value: true });
            exports.autolinkblock = void 0;
            const combinator_1 = _dereq_('../combinator');
            const autolink_1 = _dereq_('./autolink');
            const mention_1 = _dereq_('./block/paragraph/mention');
            const source_1 = _dereq_('./source');
            const typed_dom_1 = _dereq_('typed-dom');
            const array_1 = _dereq_('spica/array');
            exports.autolinkblock = combinator_1.lazy(() => combinator_1.some(combinator_1.subsequence([
                combinator_1.fmap(combinator_1.some(mention_1.mention), (es, rest) => {
                    es = es.reduce((acc, el) => array_1.push(acc, [
                        el,
                        typed_dom_1.html('br')
                    ]), []);
                    !rest && es.pop();
                ...
                combinator_1.rewrite(combinator_1.some(source_1.anyline, '>'), combinator_1.some(autolink_1.autolink))
            ])));
        },
        {
            '../combinator': 28,
            './autolink': 60,
            './block/paragraph/mention': 77,
            './source': 121,
            'spica/array': 6,
            'typed-dom': 21
        }
    ...
    63: [
        function (_dereq_, module, exports) {
            ...
            const source_1 = _dereq_('../source');
            const autolinkblock_1 = _dereq_('../autolinkblock');
            ...
            const text = combinator_1.lazy(() => combinator_1.fmap(combinator_1.some(combinator_1.union([
                ...
                combinator_1.rewrite(combinator_1.some(source_1.contentline, opener), combinator_1.convert(unindent, combinator_1.fmap(autolinkblock_1.autolinkblock, ns => [typed_dom_1.html('pre', util_1.defrag(ns))])))
    ...
    69: [
        function (_dereq_, module, exports) {
            ...
            function attributes(label, content, caption) {
                ...
                const rebase = /^[^-]+-(?:[0-9]+\.)*0$/.test(label) || global_1.undefined;
                const invalid = group !== '$' || rebase ? global_1.undefined : !content.classList.contains('math') || caption.length > 0 || global_1.undefined;
                return {
                    'data-label': label,
                    'data-group': group,
    ...
    79: [
        function (_dereq_, module, exports) {
            ...
            const text = (source, context) => {
                ...
                const ns = combinator_1.eval(autolinkblock_1.autolinkblock(block, context), []);
                ...
                for (let i = 0; i < ns.length; ++i) {
                    ...
                    if (child.classList.contains('quotation')) {
                        ...
                        ns.splice(i, 1, ...child.childNodes);
                        --i;
                        continue;
                    }
                }
    ...
    83: [
        function (_dereq_, module, exports) {
            'use strict';
            Object.defineProperty(exports, '__esModule', { value: true });
            exports.isFormatted = exports.isFixed = exports.indexee = exports.indexer = exports.url2link = exports.url = exports.autolink = exports.shortmedia = exports.media = exports.link = exports.comment = exports.htmlentity = exports.inline = void 0;
            const combinator_1 = _dereq_('../combinator');
        ...
        {
            '../combinator': 28,
            './inline/annotation': 84,
            './inline/autolink': 85,
            './inline/autolink/url': 91,
            './inline/bracket': 92,
            './inline/code': 93,
            './inline/comment': 94,
            './inline/deletion': 95,
            ...
            './inline/escape': 98,
            './inline/extension': 99,
            './inline/extension/indexee': 102,
            './inline/extension/indexer': 103,
            './inline/extension/label': 104,
            './inline/html': 106,
            './inline/htmlentity': 107,
            './inline/insertion': 108,
            './inline/link': 109,
            './inline/mark': 110,
            './inline/math': 111,
            './inline/media': 112,
            './inline/reference': 113,
            './inline/ruby': 114,
            './inline/shortmedia': 115,
            './inline/strong': 116,
            './inline/template': 117,
            './source': 121
        }
    ...
    96: [
        function (_dereq_, module, exports) {
            ...
            ]))), source_1.char('*'), false, ([as, bs, cs], rest) => util_1.isEndTight(bs) ? [
    ...
    100: [
        function (_dereq_, module, exports) {
            ...
            exports.data = combinator_1.lazy(() => combinator_1.creator(combinator_1.surround(source_1.str('[~'), combinator_1.inits([
                ...
                util_1.isEndTight(bs) ? [typed_dom_1.html('span', attributes(util_1.stringify(bs[0])), util_1.defrag(util_1.trimEnd(bs.slice(2))))] : array_1.push(array_1.unshift(as, bs), cs),
                rest
            ], ([as, bs], rest) => [
                array_1.unshift(as, bs),
                rest
    ...
    105: [
        function (_dereq_, module, exports) {
            ...
            const typed_dom_1 = _dereq_('typed-dom');
            const array_1 = _dereq_('spica/array');
            exports.placeholder = combinator_1.lazy(() => combinator_1.creator(combinator_1.surround(source_1.str(/^\[[:^]/), util_1.startTight(combinator_1.some(combinator_1.union([inline_1.inline]), ']')), source_1.char(']'), false, ([as, bs, cs], rest) => [
    ...
    121: [
        function (_dereq_, module, exports) {
            'use strict';
            Object.defineProperty(exports, '__esModule', { value: true });
            exports.anyline = exports.emptyline = exports.contentline = exports.char = exports.str = exports.unescsource = exports.escsource = exports.linebreak = exports.text = void 0;
    ...
    145: [
        ...
        {
            '../parser/inline': 83,
            '../parser/inline/extension/label': 104,
            './context': 144,
            'spica/array': 6,
            'spica/global': 12,
            'spica/multimap': 14,
    ...
    146: [
        ...
        {
            '../parser/inline/extension/indexee': 102,
            './context': 144,
            'spica/array': 6,
            'spica/global': 12,
            'spica/memoize': 13,
