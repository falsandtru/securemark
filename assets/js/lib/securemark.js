/*! securemark v0.36.0 https://github.com/falsandtru/securemark | (c) 2017, falsandtru | (Apache-2.0 AND MPL-2.0) License */
require = function e(t, n, r) {
    ...
    21: [
        ...
        },
        {
            '../../combinator': 14,
            '../block': 20,
            '../source/unescapable': 65,
            '../squash': 67,
            './util/verification': 36
        }
    ],
    22: [
        function (require, module, exports) {
                ...
                return function (source) {
                    ...
                    return __generator(this, function (_d) {
                        ...
                        case 0:
                            ...
                            ref = pairs.slice(i).reduce(function (e, _a) {
                                var _b = __read(_a, 2), es = _b[1];
                                return e || es[0];
                            }, null);
                            ps = [];
