...
また構文内外で文脈が異なる場合に当該構文の解釈を変更するCommonMarkのバックトラック回避方法は開始記号による構文の決定性、ひいては可読性を損なうため人間の利便性のために供される言語の文法には適さず、このように、構文を拡張するほど可読性が多項式的に悪化する問題および入力箇所と離れた外側の構文の解釈を変更する直感的に理解しにくい挙動を生む問題から拡張性に問題がある。
